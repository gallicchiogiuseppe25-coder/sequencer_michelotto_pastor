...
(function () {
  ...
  function render(frame) {
    ...
    // 5. Segmenti rilevati (18 celle), mappati direttamente dallo spazio di
    // analisi alla finestra visibile.
    if (gridResult && gridResult.analysisWidth && gridResult.analysisHeight) {
      drawSegments(pixelDetectorResult, gridResult.analysisWidth, gridResult.analysisHeight, windowRect);
      // Diagnostica: pallini su ogni blob rilevato, sempre visibili.
